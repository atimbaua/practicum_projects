...
- **DBeaver** — обработка и очистка исходных данных из CSV-файла, выполнение SQL-запросов для подготовки таблиц
...
├── README.md
├── docs/
│   ├── dashboard-documentation.docx     # техническая документация: метрики, источники, формулы
...
Дашборд разработан в рамках учебного проекта по BI-аналитике. Исходные данные (CSV) были предварительно обработаны и структурированы в DBeaver, после чего загружены в базу данных и подключены к Superset для построения визуализаций.
