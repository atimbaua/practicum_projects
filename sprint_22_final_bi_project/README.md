...
| Параметр | Значение |
|---|---|
| **Автор** | Андрей Панов, студент курса "BI-аналитик" |
...
- **Jupyter Notebook** — использование python (библиотеки `pandas`, `matplotlib`, `seaborn`) для проведения исследовательского анализа, а также обработки и очистки исходных данных из CSV-файла
...
├── README.md
├── data/
│   ├── marketplace_androidru.ipynb      # блокнот с python кодом
│   ├── orders_filtered.csv              # обработанный CSV-файл
├── docs/
